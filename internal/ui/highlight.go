...
// HighlightSQL returns syntax highlighted SQL using foreground-only ANSI codes
...
// HighlightSQLPreserveANSI highlights SQL while preserving existing ANSI escape sequences
// This is used for textarea views that already contain cursor/styling ANSI codes
func HighlightSQLPreserveANSI(text string) string {
	var result strings.Builder
	i := 0
